...
```python
def count_words_and_most_common(Input):
    try:
...
count_words_and_most_common('WWW.txt')
```
### Результат.
<img width="622" height="264" alt="image" src="https://github.com/user-attachments/assets/59b39af0-c812-4f1e-b09a-dd5934d3a655" />
...
```
### Результат.
<img width="947" height="849" alt="image" src="https://github.com/user-attachments/assets/b41707bf-a5c6-4cf3-8ed0-e8f241fab0a2" />
...
```
### Результат.
<img width="682" height="232" alt="image" src="https://github.com/user-attachments/assets/ce35b0d2-3e1c-4ffd-a9af-87fda8293c1d" />
...
```
### Результат.
<img width="951" height="332" alt="image" src="https://github.com/user-attachments/assets/88bfc5c8-7f33-461b-8db4-2b7ff6e4c909" />
...
```
### Результат.
<img width="907" height="161" alt="image" src="https://github.com/user-attachments/assets/da49093f-d00b-4e74-8f76-dc3dfe6dc755" />
