...
### Результат.
<img width="827" height="291" alt="image" src="https://github.com/user-attachments/assets/3873e49a-988f-4121-98dd-fefc52022b3a" />

### Выводы.

1. Класс Max использует слоты __slots__ для оптимизации памяти и ускорения доступа к атрибутам.
...
### Результат.
<img width="827" height="291" alt="image" src="https://github.com/user-attachments/assets/2eeceaf3-c342-48a2-9647-0278940c71e6" />
...
### Результат.
<img width="830" height="428" alt="image" src="https://github.com/user-attachments/assets/e105dab4-3460-4cb6-b1bd-f1154553fab9" />

### Выводы

1. Свойство позволяет использовать синтаксис obj.value вместо вызова методов напрямую.
2. Удаление атрибута приводит к ошибке при попытке получить значение после этого.
...
```
### Результат.
<img width="828" height="425" alt="image" src="https://github.com/user-attachments/assets/c6144e7c-4623-4d67-b2dd-132664eb903f" />
...
```
### Результат.
<img width="828" height="424" alt="image" src="https://github.com/user-attachments/assets/10f00579-2730-452f-b4c6-5356838bc63d" />
...
### Результат.
<img width="829" height="744" alt="image" src="https://github.com/user-attachments/assets/22dc281d-d955-46ad-be1a-03efddf5ba0b" />
